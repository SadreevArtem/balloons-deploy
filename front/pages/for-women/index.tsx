...
export async function getStaticProps() {
  ...
  const products = await api.getProducts("forWomen");
...
const ForWomen = ({ products }: { products: Product[] }) => {
  return (
    <>
      ...
      <div className={`flex flex-col justify-between ${inter.className}`}>
        <div className="md:mt-[60px] mt-16">
          <PageProducts title="Девушке" products={products} className="md:mt-[60px] mt-[46px]" />
        </div>
