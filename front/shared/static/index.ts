...
export const MetaData = {
  title: "Воздушные шары в Тюмени | Barballs72 | Доставка шаров в Тюмени",
  description: "Воздушные шары в Тюмени с доставкой можно купить в BarBalls72. Заказать гелиевые шарики и фигуры как подарок на день рождения и украшение праздника.",
  keywords: "Воздушные шары в Тюмени, Доставка шаров в Тюмени"
};
