...
export const MetaData = {
  title: "Воздушные шары в Тюмени | Barballs72 | Доставка",
  description: "Воздушные шары в Тюмени с доставкой купить в BarBalls72. Заказать гелиевые шарики, подарок на день рождения и украшение праздника.",
